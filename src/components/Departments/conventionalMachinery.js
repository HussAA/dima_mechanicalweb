    ...
    <div className="w-11/12 lg:w-10/12 xl:w-9/12 2xl:w-8/12 flex flex-col md:flex-row items-center gap-10 mx-auto">
      ...
      <div className="sm:w-8/12 w-11/12 md:w-1/2 md:order-2 order-1">
        ...
        <div className="text-[#8f705d] relative capitalize text-2xl md:text-2xl font-medium">
          {title}
          <div className="absolute top-[31px] left-0 w-1/4 border-b-4 border-orange-400" />
        </div>
        {/* Description */}
...
export default Conventionaldepartment;
