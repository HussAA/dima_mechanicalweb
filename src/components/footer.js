...
export default function Footer() {
    return (
      ...
      <div className="w-full md:w-[30%] p-4">
        <h2 className="text-[20px] md:text-[20px] mb-2 font-bold">DIMA AL UROUBA TURNERY</h2>
        <div className='text-[14px] md:text-[16px] font-semibold'>Precision Crafting for a Brighter Tomorrow | صناعة دقيقة لمستقبل أكثر إشراقًا</div>
      </div>
      ...
      <div className="w-full md:ml-auto md:w-[60%] flex flex-wrap">
        ...
        <div className="sm:w-1/3 p-4">
          <h2 className="text-base md:text-lg font-semibold mb-4">Our Social</h2>
          <ul className='font-medium'>
